...
if (isset($_POST["register-submit"])) {
...
}elseif (isset($_POST["adduser-submit"])) {
    ...
    if (invalidPassword($password) !== false) {
        header("location: ../newuser.php?error=invalidPassword");
        exit();
    }
    

    if (passwordMatch($password, $repeatPassword) !== false) {
        header("location: ../newuser.php?error=pwdsdontmatch");
        exit();
    }


    if (uidExists($connection, $username, $email) !== false) {
        header("location: ../newuser.php?error=uidExists");
        exit();
    }
